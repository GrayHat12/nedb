...
function compareThings(a, b, _compareStrings) {
    ...
    // Dates
    if (util.types.isDate(a)) {
        return util.types.isDate(b) ? compareNSB(a.getTime(), b.getTime()) : -1;
    }
    if (util.types.isDate(b)) {
        return util.types.isDate(a) ? compareNSB(a.getTime(), b.getTime()) : 1;
    }
...
function matchQueryPart(obj, queryKey, queryValue, treatObjAsValue) {
    ...
    if (
        ...
        !util.types.isRegExp(queryValue) &&
    ...
    if (util.types.isRegExp(queryValue)) {
